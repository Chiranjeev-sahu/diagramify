...
export default function EmptyState({ onGenerate }) {
  const suggestions = [
    {
      icon: GitBranch,
  ...
  return (
    <div className="flex flex-col gap-16 max-w-3xl items-center">
      ...
      <div className="w-full">
        <p className="text-sm font-medium text-gray-700 mb-3">Try these examples:</p>        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
